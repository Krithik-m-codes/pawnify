...
import { useGetMarketRatesQuery, useRefreshMarketRatesMutation } from "@/lib/redux/api/marketRatesApi";
...
export function LiveMarketTicker() {
  const { data } = useGetMarketRatesQuery(undefined, {
    pollingInterval: 15 * 60 * 1000,
  });
  const [refreshRates] = useRefreshMarketRatesMutation();
